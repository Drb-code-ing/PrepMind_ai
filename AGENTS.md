...
| Phase 6.9.5 | 验收未完成 | Review/Planner 受限只读模型候选与诊断工程已完成；隔离的 v1/v2/v3/v4 controlled-Live 均为 `invalid_attempted / structured_output`，各 1 次 provider 尝试、usage 不可验证、gate 关闭且不得重跑；v3/v4 仅在安全 evidence 中记录 `provider_json_parse` |
