...
PrepMind AI 是移动端优先的 Web + PWA 智能备考助手。Phase 7 核心工程化已完成；Phase 7.8.5 RAG runtime parity 已完成真实 Docker 验收。当前同时推进 Phase 6.9 真实模型 Agent 与分层记忆补强，完成后再进入 Phase 8 性能与 PWA、Phase 9 MCP Tool 体系。
