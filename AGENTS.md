...
1. Phase 6.9.4.3：在 `phase-6.9-router-verifier-v1` 同一 case 上运行 deterministic / Mock / controlled-Live paired eval，并以质量、安全、延迟和成本门槛决定是否启用。
