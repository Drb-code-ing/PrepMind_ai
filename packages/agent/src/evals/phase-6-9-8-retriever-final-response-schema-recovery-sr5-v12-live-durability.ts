...
import { PHASE_6_9_8_RETRIEVER_SCHEMA_RECOVERY_SR5_LIVE_SOURCE_BINDING_SCHEMA } from './phase-6-9-8-retriever-final-response-schema-recovery-sr5-v12-live-source-manifest.ts';
import {
  PHASE_6_9_8_RETRIEVER_SCHEMA_RECOVERY_SR5_LIVE_JOURNAL_RECORD_SCHEMA,
  PHASE_6_9_8_RETRIEVER_SCHEMA_RECOVERY_SR5_LIVE_JOURNAL_RECORD_VERSION,
  type Phase698RetrieverSchemaRecoverySr5LiveJournalRecord,
} from './phase-6-9-8-retriever-final-response-schema-recovery-sr5-v12-live-journal-contract.ts';
...
export { PHASE_6_9_8_RETRIEVER_SCHEMA_RECOVERY_SR5_LIVE_JOURNAL_RECORD_VERSION };
...
const FORMAL_FILE =
  /^phase-6-9-8-retriever-final-response-schema-recovery-sr5-live-v12(?:\.marker|-[0-9a-f-]{36}\.(?:journal\.jsonl|recovery\.claim|report\.json)|-[0-9a-f-]{36}\.report\.json\.tmp\.[0-9a-f-]{36})$/u;
...
export const PHASE_6_9_8_RETRIEVER_SCHEMA_RECOVERY_SR5_LIVE_MARKER_SCHEMA = z
  .object({
    ...
    authority: z.enum([
      'synthetic_test_retriever_final_response_schema_recovery_sr5_v12',
      'controlled_live_retriever_final_response_schema_recovery_sr5_v12',
    ]),
  ...
  .superRefine((marker, context) => {
    const valid =
      (marker.authority === 'synthetic_test_retriever_final_response_schema_recovery_sr5_v12' &&
        marker.credentialReads === 0) ||
      (marker.authority === 'controlled_live_retriever_final_response_schema_recovery_sr5_v12' &&
...
const JOURNAL_RECORD_SCHEMA = PHASE_6_9_8_RETRIEVER_SCHEMA_RECOVERY_SR5_LIVE_JOURNAL_RECORD_SCHEMA;
export type { Phase698RetrieverSchemaRecoverySr5LiveJournalRecord };
...
export const PHASE_6_9_8_RETRIEVER_SCHEMA_RECOVERY_SR5_LIVE_ARTIFACT_SCHEMA = z
  .object({
    ...
    qualityAuthority: z.enum(['none', 'schema_recovery_sr5_v12_branch_semantic_gate']),
    runId: UUID,
    runScope: z.literal('branch'),
  ...
  .superRefine((artifact, context) => {
    const expectedQuality =
      ...
      artifact.report.gate.passed
        ? 'schema_recovery_sr5_v12_branch_semantic_gate'
        : 'none';
    if (
...
function isLiveAuthority(
  ...
  return authority === 'controlled_live_retriever_final_response_schema_recovery_sr5_v12';
}
