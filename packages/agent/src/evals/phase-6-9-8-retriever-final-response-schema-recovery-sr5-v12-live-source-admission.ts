...
import { PHASE_6_9_8_RETRIEVER_SCHEMA_RECOVERY_SR5_LIVE_JOURNAL_RECORD_SCHEMA } from './phase-6-9-8-retriever-final-response-schema-recovery-sr5-v12-live-journal-contract.ts';
...
const LIVE_FORMAL_BASENAME =
  /^phase-6-9-8-retriever-final-response-schema-recovery-sr5-live-v12(?:\.marker|-[0-9a-f-]{36}\.(?:journal\.jsonl|report\.json|recovery\.claim|json)|-[0-9a-f-]{36}\.report\.json\.tmp\.[0-9a-f-]{36})$/u;
...
function admitLiveBoundary(
  ...
  const admission = deepFreeze({
    ...
    lineage: PHASE_6_9_8_RETRIEVER_SCHEMA_RECOVERY_SR5_LIVE_LINEAGE,
    authority: 'controlled_live_retriever_final_response_schema_recovery_sr5_v12' as const,
