...
import {
  ...
  PHASE_6_9_8_RETRIEVER_SCHEMA_RECOVERY_SR5_RUNNER_LINEAGE,
  PHASE_6_9_8_RETRIEVER_SCHEMA_RECOVERY_SR5_RUNNER_MANIFEST,
  PHASE_6_9_8_RETRIEVER_SCHEMA_RECOVERY_SR5_RUNNER_MANIFEST_SHA256,
  PHASE_6_9_8_RETRIEVER_SCHEMA_RECOVERY_SR5_RUNNER_POLICY_SHA256,
  PHASE_6_9_8_RETRIEVER_SCHEMA_RECOVERY_SR5_RUNNER_REPORT_SCHEMA,
  PHASE_6_9_8_RETRIEVER_SCHEMA_RECOVERY_SR5_RUNNER_SOURCE_SCHEMA,
  ...
  parsePhase698RetrieverSchemaRecoverySr5RunnerReport,
...
import type {
  Phase698RetrieverSchemaRecoverySr5RunnerLaneLifecycle,
...
export const PHASE_6_9_8_RETRIEVER_SCHEMA_RECOVERY_SR5_RUNNER_DURABILITY_VERSION =
  'phase-6.9.8-retriever-final-response-schema-recovery-sr5-runner-durability-v1' as const;
export const PHASE_6_9_8_RETRIEVER_SCHEMA_RECOVERY_SR5_RUNNER_MARKER_VERSION =
  'phase-6.9.8-retriever-final-response-schema-recovery-sr5-runner-marker-v1' as const;
export const PHASE_6_9_8_RETRIEVER_SCHEMA_RECOVERY_SR5_RUNNER_JOURNAL_VERSION =
  'phase-6.9.8-retriever-final-response-schema-recovery-sr5-runner-journal-record-v1' as const;
export const PHASE_6_9_8_RETRIEVER_SCHEMA_RECOVERY_SR5_RUNNER_CLAIM_VERSION =
  'phase-6.9.8-retriever-final-response-schema-recovery-sr5-runner-recovery-claim-v1' as const;
export const PHASE_6_9_8_RETRIEVER_SCHEMA_RECOVERY_SR5_RUNNER_ARTIFACT_VERSION =
  'phase-6.9.8-retriever-final-response-schema-recovery-sr5-runner-artifact-v1' as const;

export const PHASE_6_9_8_RETRIEVER_SCHEMA_RECOVERY_SR5_RUNNER_MARKER_RELATIVE_PATH =
  '.tmp/phase-6-9-8-retriever-final-response-schema-recovery-sr5-runner.marker' as const;
...
const DURABILITY_ERROR = 'PHASE_6_9_8_RETRIEVER_SCHEMA_RECOVERY_SR5_RUNNER_DURABILITY_INVALID';
const FORMAL_BASENAME =
  /^phase-6-9-8-retriever-final-response-schema-recovery-sr5-runner(?:\.marker|-[0-9a-f-]{36}\.(?:journal\.jsonl|report\.json|recovery\.claim|json))$/u;

export const PHASE_6_9_8_RETRIEVER_SCHEMA_RECOVERY_SR5_RUNNER_MARKER_SCHEMA = z
  .object({
    markerVersion: z.literal(PHASE_6_9_8_RETRIEVER_SCHEMA_RECOVERY_SR5_RUNNER_MARKER_VERSION),
    durabilityVersion: z.literal(
      PHASE_6_9_8_RETRIEVER_SCHEMA_RECOVERY_SR5_RUNNER_DURABILITY_VERSION,
    ),
...
export type Phase698RetrieverSchemaRecoverySr5RunnerMarker = z.infer<
  typeof PHASE_6_9_8_RETRIEVER_SCHEMA_RECOVERY_SR5_RUNNER_MARKER_SCHEMA
>;

export const PHASE_6_9_8_RETRIEVER_SCHEMA_RECOVERY_SR5_RUNNER_CLAIM_SCHEMA = z
  .object({
    version: z.literal(PHASE_6_9_8_RETRIEVER_SCHEMA_RECOVERY_SR5_RUNNER_CLAIM_VERSION),
    lineage: z.literal(PHASE_6_9_8_RETRIEVER_SCHEMA_RECOVERY_SR5_RUNNER_LINEAGE),
    runId: UUID,
    markerSha256: SHA256,
    claimedAt: DATETIME,
...
type RecoveryClaim = z.infer<typeof PHASE_6_9_8_RETRIEVER_SCHEMA_RECOVERY_SR5_RUNNER_CLAIM_SCHEMA>;
...
export const PHASE_6_9_8_RETRIEVER_SCHEMA_RECOVERY_SR5_RUNNER_JOURNAL_RECORD_SCHEMA = z
  .object({
    version: z.literal(PHASE_6_9_8_RETRIEVER_SCHEMA_RECOVERY_SR5_RUNNER_JOURNAL_VERSION),
    lineage: z.literal(PHASE_6_9_8_RETRIEVER_SCHEMA_RECOVERY_SR5_RUNNER_LINEAGE),
    runId: UUID,
...
export type Phase698RetrieverSchemaRecoverySr5RunnerJournalRecord = z.infer<
  typeof PHASE_6_9_8_RETRIEVER_SCHEMA_RECOVERY_SR5_RUNNER_JOURNAL_RECORD_SCHEMA
>;

export const PHASE_6_9_8_RETRIEVER_SCHEMA_RECOVERY_SR5_RUNNER_ARTIFACT_SCHEMA = z
  .object({
    version: z.literal(PHASE_6_9_8_RETRIEVER_SCHEMA_RECOVERY_SR5_RUNNER_ARTIFACT_VERSION),
    lineage: z.literal(PHASE_6_9_8_RETRIEVER_SCHEMA_RECOVERY_SR5_RUNNER_LINEAGE),
    runId: UUID,
    ...
    durability: z
      ...
      .strict(),
    report: PHASE_6_9_8_RETRIEVER_SCHEMA_RECOVERY_SR5_RUNNER_REPORT_SCHEMA,
  })
  .strict();

export type Phase698RetrieverSchemaRecoverySr5RunnerArtifact = z.infer<
  typeof PHASE_6_9_8_RETRIEVER_SCHEMA_RECOVERY_SR5_RUNNER_ARTIFACT_SCHEMA
>;

type ReplayState = {
  marker: Phase698RetrieverSchemaRecoverySr5RunnerMarker;
  markerSha256: string;
  sequence: number;
  previousHash: string;
  attemptReserved: boolean;
  guards: Phase698RetrieverSchemaRecoverySr5RunnerGuardEntry[];
  lanes: Phase698RetrieverSchemaRecoverySr5RunnerLaneEntry[];
  activeLane: Phase698RetrieverSchemaRecoverySr5RunnerLaneIdentity | null;
  activeStages: Phase698RetrieverSchemaRecoverySr5RunnerLaneStage[];
  preparedSuccess: Phase698RetrieverSchemaRecoverySr5RunnerLaneEntry | null;
  recoveryClaim: Readonly<{ claim: RecoveryClaim; claimSha256: string }> | null;
  terminal: Phase698RetrieverSchemaRecoverySr5RunnerReport | null;
...
export type Phase698RetrieverSchemaRecoverySr5RunnerReservation = Readonly<{
  runId: string;
  markerRelativePath: typeof PHASE_6_9_8_RETRIEVER_SCHEMA_RECOVERY_SR5_RUNNER_MARKER_RELATIVE_PATH;
  journalRelativePath: string;
  lifecycle: Phase698RetrieverSchemaRecoverySr5RunnerLifecycle;
  publishArtifact(
    report: Phase698RetrieverSchemaRecoverySr5RunnerReport,
  ): Promise<Readonly<{ artifactRelativePath: string; artifactSha256: string }>>;
}>;

export type Phase698RetrieverSchemaRecoverySr5RunnerCrashSealResult =
  | Readonly<{
      ok: true;
      runId: string;
      disposition: 'crash_only_sealed' | 'terminal_publication_recovered';
      artifactSha256: string;
      gate: Phase698RetrieverSchemaRecoverySr5RunnerReport['gate'];
    }>
  | Readonly<{
      ok: false;
      code:
...
export async function reservePhase698RetrieverSchemaRecoverySr5RunnerAttempt(input: {
  root: string;
  runId: string;
  createdAt: string;
...
export async function reservePhase698RetrieverSchemaRecoverySr5RunnerAttemptForTest(
  input: {
    root: string;
    runId: string;
    createdAt: string;
...
async function reserveAttempt(
  ...
  const issued = consumePhase698RetrieverSchemaRecoverySr5BoundReservationCapability(
    input.reservationCapability,
    root,
  );
  if (issued.authority !== 'synthetic_test' && issued.authority !== 'git_verified') {
    throw new Error(DURABILITY_ERROR);
  }
  const marker = PHASE_6_9_8_RETRIEVER_SCHEMA_RECOVERY_SR5_RUNNER_MARKER_SCHEMA.parse({
    markerVersion: PHASE_6_9_8_RETRIEVER_SCHEMA_RECOVERY_SR5_RUNNER_MARKER_VERSION,
    durabilityVersion: PHASE_6_9_8_RETRIEVER_SCHEMA_RECOVERY_SR5_RUNNER_DURABILITY_VERSION,
  ...
  const markerPath = resolveRelative(
    root,
    PHASE_6_9_8_RETRIEVER_SCHEMA_RECOVERY_SR5_RUNNER_MARKER_RELATIVE_PATH,
  );
  ...
  const journalRelative = phase698RetrieverSchemaRecoverySr5RunnerJournalRelativePath(marker.runId);
...
export async function validatePhase698RetrieverSchemaRecoverySr5RunnerBundle(input: {
  root: string;
}) {
  try {
    const root = await requireRoot(input.root);
    ...
    const marker = parseCanonicalLine(
      markerBytes,
      PHASE_6_9_8_RETRIEVER_SCHEMA_RECOVERY_SR5_RUNNER_MARKER_SCHEMA,
    );
    const markerSha256 = sha256(markerBytes);
    const journalPath = resolveRelative(
      root,
      phase698RetrieverSchemaRecoverySr5RunnerJournalRelativePath(marker.runId),
    );
    ...
    const reportPath = resolveRelative(
      root,
      phase698RetrieverSchemaRecoverySr5RunnerReportRelativePath(marker.runId),
    );
    const artifactPath = resolveRelative(
      root,
      phase698RetrieverSchemaRecoverySr5RunnerArtifactRelativePath(marker.runId),
    );
    ...
    const artifact = parseCanonicalLine(
      artifactBytes,
      PHASE_6_9_8_RETRIEVER_SCHEMA_RECOVERY_SR5_RUNNER_ARTIFACT_SCHEMA,
    );
    const expected = buildArtifact(replay, report);
    const reportSha = sha256Phase698RetrieverSchemaRecoverySr5Runner(
      canonicalPhase698RetrieverSchemaRecoverySr5RunnerJson(report),
    );
    const artifactSha = sha256(artifactBytes);
    if (
      canonicalPhase698RetrieverSchemaRecoverySr5RunnerJson(artifact) !==
        canonicalPhase698RetrieverSchemaRecoverySr5RunnerJson(expected) ||
...
export function sealPhase698RetrieverSchemaRecoverySr5RunnerInterruptedAttempt(input: {
  root: string;
}): Promise<Phase698RetrieverSchemaRecoverySr5RunnerCrashSealResult> {
  return sealInterrupted(input.root, inspectProcess);
}

/** Synthetic-only process identity seam. */
export function sealPhase698RetrieverSchemaRecoverySr5RunnerInterruptedAttemptForTest(input: {
  root: string;
...
async function sealInterrupted(
  ...
  let root: string;
  let marker: Phase698RetrieverSchemaRecoverySr5RunnerMarker;
  let markerBytes: string;
  try {
    root = await requireRoot(rootInput);
    markerBytes = await readRegular(
      resolveRelative(root, PHASE_6_9_8_RETRIEVER_SCHEMA_RECOVERY_SR5_RUNNER_MARKER_RELATIVE_PATH),
    );
  ...
  try {
    ...
    const validation = await validatePhase698RetrieverSchemaRecoverySr5RunnerBundle({ root });
...
function reservationFromState(state: ReservationState, journalRelativePath: string) {
  const lifecycle: Phase698RetrieverSchemaRecoverySr5RunnerLifecycle = Object.freeze({
    ...
    reserveLane: (identity) =>
      enqueueResult(state, async () => {
        ...
        const laneLifecycle: Phase698RetrieverSchemaRecoverySr5RunnerLaneLifecycle = Object.freeze({
  ...
  return Object.freeze({
    runId: state.marker.runId,
    markerRelativePath: PHASE_6_9_8_RETRIEVER_SCHEMA_RECOVERY_SR5_RUNNER_MARKER_RELATIVE_PATH,
    journalRelativePath,
    lifecycle,
    publishArtifact: (report: Phase698RetrieverSchemaRecoverySr5RunnerReport) =>
...
async function appendGuard(
  ...
  input: Phase698RetrieverSchemaRecoverySr5RunnerGuardEntry,
) {
  const entry = PHASE_6_9_8_RETRIEVER_SCHEMA_RECOVERY_SR5_RUNNER_GUARD_ENTRY_SCHEMA.parse(input);
  ...
  await appendRecord(state, 'lane_stage', {
    ...
    preparedSuccess:
      preparedSuccess === undefined
        ? null
        : PHASE_6_9_8_RETRIEVER_SCHEMA_RECOVERY_SR5_RUNNER_LANE_ENTRY_SCHEMA.parse(preparedSuccess),
  });
}

async function appendLaneTerminal(
  state: ReservationState,
  input: Phase698RetrieverSchemaRecoverySr5RunnerLaneEntry,
) {
  const entry = PHASE_6_9_8_RETRIEVER_SCHEMA_RECOVERY_SR5_RUNNER_LANE_ENTRY_SCHEMA.parse(input);
  await appendRecord(state, 'lane_terminal', { entry });
}

async function appendRunTerminal(
  state: ReservationState,
  input: Phase698RetrieverSchemaRecoverySr5RunnerReport,
  completionMode: 'runtime' | 'recovery',
) {
  const parsed = parsePhase698RetrieverSchemaRecoverySr5RunnerReport(input);
  ...
  if (
    canonicalPhase698RetrieverSchemaRecoverySr5RunnerJson(parsed) !==
    canonicalPhase698RetrieverSchemaRecoverySr5RunnerJson(recomputed)
  ) {
    throw new Error(DURABILITY_ERROR);
  }
...
async function publishArtifact(
  state: ReservationState,
  reportInput: Phase698RetrieverSchemaRecoverySr5RunnerReport,
) {
  const report = parsePhase698RetrieverSchemaRecoverySr5RunnerReport(reportInput);
  if (!report || !state.terminal) throw new Error(DURABILITY_ERROR);
  if (
    canonicalPhase698RetrieverSchemaRecoverySr5RunnerJson(report) !==
    canonicalPhase698RetrieverSchemaRecoverySr5RunnerJson(state.terminal)
  ) {
    throw new Error(DURABILITY_ERROR);
  }
  const reportSha256 = sha256Phase698RetrieverSchemaRecoverySr5Runner(
    canonicalPhase698RetrieverSchemaRecoverySr5RunnerJson(report),
  );
  const reportRelativePath = phase698RetrieverSchemaRecoverySr5RunnerReportRelativePath(
    state.marker.runId,
  );
  const artifactRelativePath = phase698RetrieverSchemaRecoverySr5RunnerArtifactRelativePath(
    state.marker.runId,
  );
...
function buildArtifact(
  state: ReplayState,
  report: Phase698RetrieverSchemaRecoverySr5RunnerReport,
): Phase698RetrieverSchemaRecoverySr5RunnerArtifact {
  if (!state.publicationStarted) throw new Error(DURABILITY_ERROR);
  return PHASE_6_9_8_RETRIEVER_SCHEMA_RECOVERY_SR5_RUNNER_ARTIFACT_SCHEMA.parse({
    version: PHASE_6_9_8_RETRIEVER_SCHEMA_RECOVERY_SR5_RUNNER_ARTIFACT_VERSION,
    lineage: PHASE_6_9_8_RETRIEVER_SCHEMA_RECOVERY_SR5_RUNNER_LINEAGE,
    runId: state.marker.runId,
    reportLogicalSha256: sha256Phase698RetrieverSchemaRecoverySr5Runner(
      canonicalPhase698RetrieverSchemaRecoverySr5RunnerJson(report),
    ),
    durability: {
...
async function completeRecovery(state: ReservationState) {
  while (state.guards.length < 8) {
    const testCase =
      PHASE_6_9_8_RETRIEVER_SCHEMA_RECOVERY_SR5_RUNNER_MANIFEST.guardCases[state.guards.length];
    if (!testCase) throw new Error(DURABILITY_ERROR);
    await appendGuard(
      state,
      PHASE_6_9_8_RETRIEVER_SCHEMA_RECOVERY_SR5_RUNNER_GUARD_ENTRY_SCHEMA.parse({
        kind: 'guard',
...
function recoveryNotStarted(identity: Phase698RetrieverSchemaRecoverySr5RunnerLaneIdentity) {
  return PHASE_6_9_8_RETRIEVER_SCHEMA_RECOVERY_SR5_RUNNER_LANE_ENTRY_SCHEMA.parse({
    kind: 'candidate_lane',
    ...identity,
    transportAuthority: 'synthetic_injected',
...
function recomputeReport(state: ReplayState, completionMode: 'runtime' | 'recovery') {
  return buildPhase698RetrieverSchemaRecoverySr5RunnerReport({
    runId: state.marker.runId,
    completionMode,
...
> {
  const path = resolveRelative(
    root,
    phase698RetrieverSchemaRecoverySr5RunnerRecoveryClaimRelativePath(replay.marker.runId),
  );
  if (await pathExists(path)) {
    try {
      ...
      const claim = parseCanonicalLine(
        bytes,
        PHASE_6_9_8_RETRIEVER_SCHEMA_RECOVERY_SR5_RUNNER_CLAIM_SCHEMA,
      );
  ...
  const claim = PHASE_6_9_8_RETRIEVER_SCHEMA_RECOVERY_SR5_RUNNER_CLAIM_SCHEMA.parse({
    version: PHASE_6_9_8_RETRIEVER_SCHEMA_RECOVERY_SR5_RUNNER_CLAIM_VERSION,
    lineage: PHASE_6_9_8_RETRIEVER_SCHEMA_RECOVERY_SR5_RUNNER_LINEAGE,
...
async function validateClaim(root: string, replay: ReplayState) {
  ...
  if (
    ...
    canonicalPhase698RetrieverSchemaRecoverySr5RunnerJson(claim) !==
      canonicalPhase698RetrieverSchemaRecoverySr5RunnerJson(replay.recoveryClaim.claim)
  ) {
    throw new Error(DURABILITY_ERROR);
  }
}
...
function nextRecord(
  state: ReplayState,
  event: Phase698RetrieverSchemaRecoverySr5RunnerJournalRecord['event'],
  payload: unknown,
) {
  const withoutHash = {
    version: PHASE_6_9_8_RETRIEVER_SCHEMA_RECOVERY_SR5_RUNNER_JOURNAL_VERSION,
    lineage: PHASE_6_9_8_RETRIEVER_SCHEMA_RECOVERY_SR5_RUNNER_LINEAGE,
    runId: state.marker.runId,
  ...
  return PHASE_6_9_8_RETRIEVER_SCHEMA_RECOVERY_SR5_RUNNER_JOURNAL_RECORD_SCHEMA.parse({
    ...withoutHash,
    recordHash: sha256(canonicalPhase698RetrieverSchemaRecoverySr5RunnerJson(withoutHash)),
  });
}
...
function parseJournal(
  ...
  const records = lines.map((line) => {
    const parsed = PHASE_6_9_8_RETRIEVER_SCHEMA_RECOVERY_SR5_RUNNER_JOURNAL_RECORD_SCHEMA.parse(
      JSON.parse(line),
    );
    if (line !== canonicalPhase698RetrieverSchemaRecoverySr5RunnerJson(parsed)) {
      throw new Error(DURABILITY_ERROR);
    }
    return parsed;
  });
...
function replayRecords(
  marker: Phase698RetrieverSchemaRecoverySr5RunnerMarker,
  markerSha256: string,
  records: readonly Phase698RetrieverSchemaRecoverySr5RunnerJournalRecord[],
) {
...
function applyRecord(
  state: ReplayState,
  record: Phase698RetrieverSchemaRecoverySr5RunnerJournalRecord,
) {
  ...
  switch (record.event) {
    ...
    case 'guard_terminal': {
      const payload = parsePayload(record.payload, {
        entry: PHASE_6_9_8_RETRIEVER_SCHEMA_RECOVERY_SR5_RUNNER_GUARD_ENTRY_SCHEMA,
      });
    ...
    case 'lane_reserved': {
      ...
      const expected =
        expectedPhase698RetrieverSchemaRecoverySr5RunnerLaneSchedule()[state.lanes.length];
      if (
        state.guards.length !== 8 ||
        state.activeLane ||
        state.terminal ||
        !expected ||
        canonicalPhase698RetrieverSchemaRecoverySr5RunnerJson(payload.identity) !==
          canonicalPhase698RetrieverSchemaRecoverySr5RunnerJson(expected)
      ) {
        throw new Error(DURABILITY_ERROR);
      }
    ...
    case 'lane_stage': {
      const payload = parsePayload(record.payload, {
        ...
        preparedSuccess:
          PHASE_6_9_8_RETRIEVER_SCHEMA_RECOVERY_SR5_RUNNER_LANE_ENTRY_SCHEMA.nullable(),
      });
      ...
      if (
        ...
        canonicalPhase698RetrieverSchemaRecoverySr5RunnerJson(payload.identity) !==
          canonicalPhase698RetrieverSchemaRecoverySr5RunnerJson(state.activeLane) ||
    ...
    case 'lane_terminal': {
      const payload = parsePayload(record.payload, {
        entry: PHASE_6_9_8_RETRIEVER_SCHEMA_RECOVERY_SR5_RUNNER_LANE_ENTRY_SCHEMA,
      });
      const expected =
        expectedPhase698RetrieverSchemaRecoverySr5RunnerLaneSchedule()[state.lanes.length];
      ...
      if (payload.entry.disposition.startsWith('not_started_')) {
        ...
        if (
          ...
          (!state.preparedSuccess ||
            canonicalPhase698RetrieverSchemaRecoverySr5RunnerJson(payload.entry) !==
              canonicalPhase698RetrieverSchemaRecoverySr5RunnerJson(state.preparedSuccess))
        ) {
          throw new Error(DURABILITY_ERROR);
        }
      }
    ...
    case 'recovery_claimed': {
      const payload = parsePayload(record.payload, {
        claim: PHASE_6_9_8_RETRIEVER_SCHEMA_RECOVERY_SR5_RUNNER_CLAIM_SCHEMA,
        claimSha256: SHA256,
      });
      if (
    ...
    case 'run_terminal': {
      ...
      const parsed = parsePhase698RetrieverSchemaRecoverySr5RunnerReport(payload.report);
    ...
    case 'publication_started': {
      ...
      if (
        ...
        payload.artifactRelativePath !==
          phase698RetrieverSchemaRecoverySr5RunnerArtifactRelativePath(state.marker.runId) ||
...
async function requireOnlyExpectedFiles(root: string, replay: ReplayState) {
  const expected = new Set([
    PHASE_6_9_8_RETRIEVER_SCHEMA_RECOVERY_SR5_RUNNER_MARKER_RELATIVE_PATH,
    phase698RetrieverSchemaRecoverySr5RunnerJournalRelativePath(replay.marker.runId),
    phase698RetrieverSchemaRecoverySr5RunnerReportRelativePath(replay.marker.runId),
    phase698RetrieverSchemaRecoverySr5RunnerArtifactRelativePath(replay.marker.runId),
...
function canonicalLine(value: unknown) {
  return `${canonicalPhase698RetrieverSchemaRecoverySr5RunnerJson(value)}\n`;
}
...
export function phase698RetrieverSchemaRecoverySr5RunnerJournalRelativePath(runId: string) {
  UUID.parse(runId);
  return `.tmp/phase-6-9-8-retriever-final-response-schema-recovery-sr5-runner-${runId}.journal.jsonl`;
}

export function phase698RetrieverSchemaRecoverySr5RunnerReportRelativePath(runId: string) {
  UUID.parse(runId);
  return `.tmp/phase-6-9-8-retriever-final-response-schema-recovery-sr5-runner-${runId}.report.json`;
}

export function phase698RetrieverSchemaRecoverySr5RunnerRecoveryClaimRelativePath(runId: string) {
  UUID.parse(runId);
  return `.tmp/phase-6-9-8-retriever-final-response-schema-recovery-sr5-runner-${runId}.recovery.claim`;
}

export function phase698RetrieverSchemaRecoverySr5RunnerArtifactRelativePath(runId: string) {
  UUID.parse(runId);
  return `phase-6-9-8-retriever-final-response-schema-recovery-sr5-runner-${runId}.json`;
}

/** Test-only cleanup for isolated temporary roots. Never use on repository evidence. */
export async function removePhase698RetrieverSchemaRecoverySr5RunnerTempRootForTest(root: string) {
