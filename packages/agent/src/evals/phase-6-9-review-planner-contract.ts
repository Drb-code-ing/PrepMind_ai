...
export enum ReviewPlannerDiagnosticCode {
  ...
  ProviderJsonParse = 'provider_json_parse',
  ProviderTypeValidation = 'provider_type_validation',
  ProviderObjectMissing = 'provider_object_missing',
  RuntimeSchemaInvalid = 'runtime_schema_invalid',
