...
export const PHASE_6_9_8_ARCHITECTURE_RECOVERY_SOURCE_PATHS = Object.freeze([
  ...
  'packages/agent/scripts/phase-6-9-8-retriever-final-response-architecture-recovery-r5-cli.ts',
  ...
  'packages/agent/src/evals/phase-6-9-8-retriever-final-response-architecture-recovery-r5-cli-core.ts',
  'packages/agent/src/evals/phase-6-9-8-retriever-final-response-architecture-recovery-r5-live.ts',
  ...
  'packages/agent/tests/phase-6-9-8-retriever-final-response-architecture-recovery-r5-cli.test.ts',
