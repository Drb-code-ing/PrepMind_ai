...
export const PHASE_6_9_7_TUTOR_ORGANIZER_RUNNER_VERSION_V7 =
  'phase-6.9.7-tutor-organizer-runner-v7' as const;
export const PHASE_6_9_7_V7_RUNTIME_EVIDENCE_VERSION =
  'phase-6.9.7-v7-runtime-evidence-v1' as const;
export const PHASE_6_9_7_V7_MARKER_VERSION = 'phase-6.9.7-v7-live-marker-v1' as const;
export const PHASE_6_9_7_V7_JOURNAL_VERSION = 'phase-6.9.7-v7-journal-v1' as const;
export const PHASE_6_9_7_V7_EVIDENCE_VERSION = 'phase-6.9.7-v7-evidence-envelope-v1' as const;
export const PHASE_6_9_7_V7_RECOVERY_CLAIM_VERSION = 'phase-6.9.7-v7-recovery-claim-v1' as const;
export const PHASE_6_9_7_V7_EVIDENCE_PREFIX = 'phase-6-9-7-tutor-organizer-v7' as const;
export const PHASE_6_9_7_V7_APPROVAL_ENV = 'PHASE_6_9_7_V7_CONTROLLED_LIVE_APPROVED' as const;
export const PHASE_6_9_7_V7_CONFIRMATION =
  'I_ACCEPT_PHASE_6_9_7_TUTOR_ORGANIZER_V7_CONTROLLED_LIVE_ONCE' as const;
export const PHASE_6_9_7_V7_MARKER_PATH =
  '.tmp/phase-6-9-7-tutor-organizer-v7-controlled-live.marker' as const;
export const PHASE_6_9_7_V7_RECOVERY_CLAIM_PATH =
  '.tmp/phase-6-9-7-tutor-organizer-v7-controlled-live.recovery.claim' as const;
export const PHASE_6_9_7_V7_EVAL_POLICY_VERSION = 'phase-6.9.7-v7-eval-policy-v1' as const;
export const PHASE_6_9_7_V7_SOURCE_MANIFEST_VERSION = 'phase-6.9.7-v7-source-manifest-v1' as const;

export const PHASE_6_9_7_V7_EVAL_POLICY = deepFreeze({
  version: PHASE_6_9_7_V7_EVAL_POLICY_VERSION,
  ...
  wire: {
    ...
    verifiedUsages: 48,
    successStages: PHASE_6_9_7_V7_WIRE_STAGES,
  },
  incompleteFormalAggregates: 'null',
  retry: false,
});

export const PHASE_6_9_7_V7_EVAL_POLICY_SHA256 = sha256Stable(PHASE_6_9_7_V7_EVAL_POLICY);

export const PHASE_6_9_7_V7_SEMANTIC_AUTHORITY_SHA256 = sha256Stable(phase697V6IdentitySnapshot());

export const PHASE_6_9_7_V7_SOURCE_MANIFEST = deepFreeze({
  version: PHASE_6_9_7_V7_SOURCE_MANIFEST_VERSION,
  runnerVersion: PHASE_6_9_7_TUTOR_ORGANIZER_RUNNER_VERSION_V7,
  runtimeEvidenceVersion: PHASE_6_9_7_V7_RUNTIME_EVIDENCE_VERSION,
  adapterVersion: FIRST_PARTY_DEEPSEEK_V4_PRO_DIRECT_ADAPTER_VERSION,
  wireDiagnosticsVersion: PHASE_6_9_7_V7_WIRE_DIAGNOSTICS_VERSION,
  ...
  evalPolicyVersion: PHASE_6_9_7_V7_EVAL_POLICY_VERSION,
  evalPolicySha256: PHASE_6_9_7_V7_EVAL_POLICY_SHA256,
  semanticAuthority: phase697V6IdentitySnapshot(),
});

export const PHASE_6_9_7_V7_SOURCE_MANIFEST_SHA256 = sha256Stable(PHASE_6_9_7_V7_SOURCE_MANIFEST);
...
export const PHASE_6_9_7_V7_WIRE_SNAPSHOT_SCHEMA = z
  .object({
    version: z.literal(PHASE_6_9_7_V7_WIRE_DIAGNOSTICS_VERSION),
    state: z.enum(['active', 'succeeded', 'failed']),
    stages: z.array(z.enum(PHASE_6_9_7_V7_WIRE_STAGES)).max(PHASE_6_9_7_V7_WIRE_STAGES.length),
  ...
  .superRefine((value, context) => {
    ...
    const expectedPrefix = PHASE_6_9_7_V7_WIRE_STAGES.slice(0, value.stages.length);
    if (JSON.stringify(value.stages) !== JSON.stringify(expectedPrefix)) {
      issue('V7 wire stage prefix mismatch');
    }
    if (value.lastCompletedStage !== (value.stages.at(-1) ?? null)) {
      issue('V7 wire last stage mismatch');
    }
    ...
    if (JSON.stringify(value.counters) !== JSON.stringify(expectedCounters)) {
      issue('V7 wire counter mismatch');
    }
    if (
      (value.state === 'failed') !== (value.failureCategory !== null) ||
      (value.state === 'succeeded' &&
        (value.stages.length !== PHASE_6_9_7_V7_WIRE_STAGES.length ||
      ...
      issue('V7 wire terminal mismatch');
    }
  });

export const PHASE_6_9_7_V7_WIRE_EVIDENCE_SCHEMA = z.discriminatedUnion('disposition', [
  ...
  z
    .object({
      ...
      snapshot: PHASE_6_9_7_V7_WIRE_SNAPSHOT_SCHEMA,
    })
    .strict(),
]);

export type Phase697V7WireEvidence = z.infer<typeof PHASE_6_9_7_V7_WIRE_EVIDENCE_SCHEMA>;

export const PHASE_6_9_7_V7_CASE_ENTRY_SCHEMA = z
  .object({
    runtimeEvidenceVersion: z.literal(PHASE_6_9_7_V7_RUNTIME_EVIDENCE_VERSION),
    caseId: caseIdSchema,
    agent: agentSchema,
    ...
    safety: safetySchema,
    wireEvidence: PHASE_6_9_7_V7_WIRE_EVIDENCE_SCHEMA,
  })
  .strict()
  .superRefine((value, context) => {
    const issue = (message: string) => context.addIssue({ code: z.ZodIssueCode.custom, message });
    const v6Projection = projectPhase697V7EntryToV6Unchecked(value);
    if (!PHASE_6_9_7_V6_CASE_ENTRY_SCHEMA.safeParse(v6Projection).success) {
      issue('V7 semantic entry projection mismatch');
    }
    ...
    if (
      ...
      issue('V7 entry wire disposition mismatch');
    }
    ...
    if (wireFailureCategory !== null && value.providerFailureCategory !== null) {
      ...
      if (
        ...
        issue('V7 entry provider failure projection mismatch');
      }
    }
  });

export type Phase697V7CaseEntry = z.infer<typeof PHASE_6_9_7_V7_CASE_ENTRY_SCHEMA>;

const identitiesSchema = z
  .object({
    sourceManifestVersion: z.literal(PHASE_6_9_7_V7_SOURCE_MANIFEST_VERSION),
    sourceManifestSha256: z.literal(PHASE_6_9_7_V7_SOURCE_MANIFEST_SHA256),
    adapterVersion: z.literal(FIRST_PARTY_DEEPSEEK_V4_PRO_DIRECT_ADAPTER_VERSION),
    wireDiagnosticsVersion: z.literal(PHASE_6_9_7_V7_WIRE_DIAGNOSTICS_VERSION),
    ...
    evalPolicyVersion: z.literal(PHASE_6_9_7_V7_EVAL_POLICY_VERSION),
    evalPolicySha256: z.literal(PHASE_6_9_7_V7_EVAL_POLICY_SHA256),
    semanticAuthoritySha256: z.literal(PHASE_6_9_7_V7_SEMANTIC_AUTHORITY_SHA256),
  })
  .strict();
...
export const PHASE_6_9_7_TUTOR_ORGANIZER_V7_REPORT_SCHEMA = z
  .object({
    runId: runIdSchema,
    runScope: z.enum(['branch', 'main']),
    mode: z.enum(['mock', 'live']),
    runnerVersion: z.literal(PHASE_6_9_7_TUTOR_ORGANIZER_RUNNER_VERSION_V7),
    identities: identitiesSchema,
    provider: z.enum(['mock', 'deepseek']),
    model: z.enum(['mock', 'deepseek-v4-pro']),
    structuredOutputMode: z.enum(['mock_json_v7', 'deepseek_v4_pro_direct_json']),
    ...
    caseEntries: z.array(PHASE_6_9_7_V7_CASE_ENTRY_SCHEMA).length(72),
  ...
  .superRefine((value, context) => {
    const issue = (message: string) => context.addIssue({ code: z.ZodIssueCode.custom, message });
    const projected = projectPhase697V7ReportToV6(value);
    if (projected === null) {
      issue('V7 semantic report projection mismatch');
      return;
    }
    ...
    if (
      JSON.stringify(value.identities) !== JSON.stringify(phase697V7IdentitySnapshot()) ||
      ...
      issue('V7 derived aggregate mismatch');
    }
    if (
      (value.mode === 'mock' &&
        (value.provider !== 'mock' ||
          value.model !== 'mock' ||
          value.structuredOutputMode !== 'mock_json_v7' ||
      ...
      issue('V7 mode identity mismatch');
    }
  });

export type Phase697TutorOrganizerV7Report = z.infer<
  typeof PHASE_6_9_7_TUTOR_ORGANIZER_V7_REPORT_SCHEMA
>;

export const PHASE_6_9_7_V7_MARKER_SCHEMA = z
  .object({
    markerVersion: z.literal(PHASE_6_9_7_V7_MARKER_VERSION),
    runnerVersion: z.literal(PHASE_6_9_7_TUTOR_ORGANIZER_RUNNER_VERSION_V7),
    sourceManifestSha256: z.literal(PHASE_6_9_7_V7_SOURCE_MANIFEST_SHA256),
    datasetBindingSha256: z.literal(PHASE_6_9_7_V6_DATASET_BINDING_SHA256),
    datasetSha256: z.literal(PHASE_6_9_TUTOR_WRONG_QUESTION_V2_DATASET_SHA256),
...
export type Phase697V7Marker = z.infer<typeof PHASE_6_9_7_V7_MARKER_SCHEMA>;

export const PHASE_6_9_7_V7_RECOVERY_CLAIM_SCHEMA = z
  .object({
    claimVersion: z.literal(PHASE_6_9_7_V7_RECOVERY_CLAIM_VERSION),
    runnerVersion: z.literal(PHASE_6_9_7_TUTOR_ORGANIZER_RUNNER_VERSION_V7),
    runId: runIdSchema,
    ownerProcessId: z.number().int().safe().positive(),
...
export type Phase697V7RecoveryClaimRecord = z.infer<typeof PHASE_6_9_7_V7_RECOVERY_CLAIM_SCHEMA>;
...
export const PHASE_6_9_7_V7_EVIDENCE_ENVELOPE_SCHEMA = z
  .object({
    evidenceVersion: z.literal(PHASE_6_9_7_V7_EVIDENCE_VERSION),
    runnerVersion: z.literal(PHASE_6_9_7_TUTOR_ORGANIZER_RUNNER_VERSION_V7),
    runId: runIdSchema,
    runScope: z.enum(['branch', 'main']),
    mode: z.enum(['mock', 'live']),
    ...
    report: PHASE_6_9_7_TUTOR_ORGANIZER_V7_REPORT_SCHEMA,
  })
  .strict()
  .superRefine((value, context) => {
    if (
      ...
      value.reportSha256 !== sha256Phase697V7Stable(value.report) ||
      ...
      context.addIssue({ code: z.ZodIssueCode.custom, message: 'V7 evidence identity mismatch' });
    }
  });

export type Phase697V7EvidenceEnvelope = z.infer<typeof PHASE_6_9_7_V7_EVIDENCE_ENVELOPE_SCHEMA>;

export function phase697V7IdentitySnapshot() {
  return deepFreeze({
    sourceManifestVersion: PHASE_6_9_7_V7_SOURCE_MANIFEST_VERSION,
    sourceManifestSha256: PHASE_6_9_7_V7_SOURCE_MANIFEST_SHA256,
    adapterVersion: FIRST_PARTY_DEEPSEEK_V4_PRO_DIRECT_ADAPTER_VERSION,
    wireDiagnosticsVersion: PHASE_6_9_7_V7_WIRE_DIAGNOSTICS_VERSION,
    datasetBindingVersion: PHASE_6_9_7_V6_DATASET_BINDING_VERSION,
    datasetBindingSha256: PHASE_6_9_7_V6_DATASET_BINDING_SHA256,
    ...
    evalPolicyVersion: PHASE_6_9_7_V7_EVAL_POLICY_VERSION,
    evalPolicySha256: PHASE_6_9_7_V7_EVAL_POLICY_SHA256,
    semanticAuthoritySha256: PHASE_6_9_7_V7_SEMANTIC_AUTHORITY_SHA256,
  });
}

export function buildPhase697V7Marker(input: {
  runId: string;
  runScope: 'branch' | 'main';
  executorProvenance?: 'first_party_deepseek_v4_pro_direct' | 'synthetic_test';
  ownerProcessId?: number;
}): Phase697V7Marker {
  return PHASE_6_9_7_V7_MARKER_SCHEMA.parse({
    markerVersion: PHASE_6_9_7_V7_MARKER_VERSION,
    runnerVersion: PHASE_6_9_7_TUTOR_ORGANIZER_RUNNER_VERSION_V7,
    sourceManifestSha256: PHASE_6_9_7_V7_SOURCE_MANIFEST_SHA256,
    datasetBindingSha256: PHASE_6_9_7_V6_DATASET_BINDING_SHA256,
    datasetSha256: PHASE_6_9_TUTOR_WRONG_QUESTION_V2_DATASET_SHA256,
...
export function buildPhase697TutorOrganizerV7Report(input: {
  v6Report: Readonly<Phase697TutorOrganizerV6Report>;
  wireSnapshots: ReadonlyMap<string, Readonly<Phase697V7WireSnapshot>>;
  executorProvenance: 'mock_synthetic' | 'first_party_deepseek_v4_pro_direct' | 'synthetic_test';
}): Readonly<Phase697TutorOrganizerV7Report> {
  const caseEntries = input.v6Report.caseEntries.map((entry) =>
    buildPhase697V7CaseEntry(entry, input.wireSnapshots.get(entry.caseId) ?? null),
  );
  ...
  const report = {
    ...
    runnerVersion: PHASE_6_9_7_TUTOR_ORGANIZER_RUNNER_VERSION_V7,
    identities: phase697V7IdentitySnapshot(),
    provider: input.v6Report.provider,
    model: input.v6Report.model,
    structuredOutputMode:
      input.v6Report.mode === 'mock' ? 'mock_json_v7' : 'deepseek_v4_pro_direct_json',
  ...
  return deepFreeze(PHASE_6_9_7_TUTOR_ORGANIZER_V7_REPORT_SCHEMA.parse(report));
}

export function buildPhase697V7CaseEntry(
  entry: Readonly<Phase697V6CaseEntry>,
  snapshot: Readonly<Phase697V7WireSnapshot> | null,
): Readonly<Phase697V7CaseEntry> {
  const canonicalSnapshot = snapshot ? PHASE_6_9_7_V7_WIRE_SNAPSHOT_SCHEMA.parse(snapshot) : null;
  const wireEvidence: Phase697V7WireEvidence = canonicalSnapshot
  ...
  return deepFreeze(
    PHASE_6_9_7_V7_CASE_ENTRY_SCHEMA.parse({
      runtimeEvidenceVersion: PHASE_6_9_7_V7_RUNTIME_EVIDENCE_VERSION,
      caseId: entry.caseId,
      agent: entry.agent,
...
export function projectPhase697V7EntryToV6(
  ...
  const parsed = PHASE_6_9_7_V6_CASE_ENTRY_SCHEMA.safeParse(
    projectPhase697V7EntryToV6Unchecked(entry),
  );
  return parsed.success ? deepFreeze(parsed.data) : null;
}

export function buildPhase697V7EvidenceEnvelope(input: {
  report: Readonly<Phase697TutorOrganizerV7Report>;
...
}): Readonly<Phase697V7EvidenceEnvelope> | null {
  const parsed = PHASE_6_9_7_V7_EVIDENCE_ENVELOPE_SCHEMA.safeParse({
    evidenceVersion: PHASE_6_9_7_V7_EVIDENCE_VERSION,
    runnerVersion: PHASE_6_9_7_TUTOR_ORGANIZER_RUNNER_VERSION_V7,
    ...
    reportSha256: sha256Phase697V7Stable(input.report),
    report: input.report,
  });
  return parsed.success ? deepFreeze(parsed.data) : null;
}

export function parsePhase697TutorOrganizerV7Report(
  input: unknown,
): Readonly<Phase697TutorOrganizerV7Report> | null {
  const cloned = clonePlainEvidenceData(input);
  if (!cloned.ok || containsLegacyArtifactIdentity(cloned.value)) return null;
  const parsed = PHASE_6_9_7_TUTOR_ORGANIZER_V7_REPORT_SCHEMA.safeParse(cloned.value);
  return parsed.success ? deepFreeze(parsed.data) : null;
}

export function phase697V7JournalPath(runId: string): string | null {
  return isUuid(runId)
    ? `.tmp/phase-6-9-7-tutor-organizer-v7-controlled-live-${runId}.journal.jsonl`
    : null;
}

export function phase697V7RecoveryClaimPath(runId: string): string | null {
  return isUuid(runId)
    ? `.tmp/phase-6-9-7-tutor-organizer-v7-controlled-live-${runId}.recovery.claim`
    : null;
}

export function phase697V7EvidencePath(input: {
  runId: string;
  runScope: 'branch' | 'main';
  mode: 'mock' | 'live';
}): string | null {
  return isUuid(input.runId)
    ? `.tmp/phase-6-9-7-tutor-organizer-v7-${input.runScope}-${input.mode}-${input.runId}.json`
    : null;
}

export function phase697V7DispatchKeySha256(input: {
  runId: string;
...
export function sha256Phase697V7Stable(value: unknown): `sha256:${string}` {
  return sha256Stable(value);
}

function projectPhase697V7ReportToV6(
  report: Readonly<Phase697TutorOrganizerV7Report>,
): Readonly<Phase697TutorOrganizerV6Report> | null {
  try {
    const entries = report.caseEntries.map(projectPhase697V7EntryToV6);
...
function projectPhase697V7EntryToV6Unchecked(
  entry: Phase697V7CaseEntry | z.input<typeof PHASE_6_9_7_V7_CASE_ENTRY_SCHEMA>,
) {
...
function aggregateWire(entries: readonly Phase697V7CaseEntry[]) {
...
function formalAggregatesComplete(
  ...
  entries: readonly Phase697V7CaseEntry[],
...
function wireSnapshotIsCompleteSuccess(snapshot: Readonly<Phase697V7WireSnapshot>) {
  return (
    snapshot.state === 'succeeded' &&
...
function projectWireFailure(category: NonNullable<Phase697V7WireSnapshot['failureCategory']>): {
...
const LEGACY_ARTIFACT_IDENTITIES = Object.freeze([
  ...Array.from({ length: 6 }, (_, index) => `phase-6.9.7-tutor-organizer-runner-v${index + 1}`),
  ...Array.from({ length: 6 }, (_, index) => `phase-6.9.7-v${index + 1}-live-marker-v1`),
  ...Array.from({ length: 6 }, (_, index) => `phase-6.9.7-v${index + 1}-journal-v1`),
  ...Array.from({ length: 6 }, (_, index) => `phase-6.9.7-v${index + 1}-evidence-envelope-v1`),
]);
...
function sortStableValue(value: unknown): unknown {
  ...
  if (typeof value === 'number') {
    if (!Number.isFinite(value)) throw new Error('PHASE_6_9_7_V7_NON_FINITE_VALUE');
    return value;
  }
  if (Array.isArray(value)) return value.map(sortStableValue);
  if (typeof value !== 'object') throw new Error('PHASE_6_9_7_V7_UNSUPPORTED_VALUE');
  const prototype = Reflect.getPrototypeOf(value);
  if (prototype !== Object.prototype && prototype !== null) {
    throw new Error('PHASE_6_9_7_V7_NON_PLAIN_VALUE');
  }
