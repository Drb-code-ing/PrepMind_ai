...
} from './phase-6-9-8-retriever-final-response-schema-recovery-sr5-v11-live-runner.ts';
import {
...
} from './phase-6-9-8-retriever-final-response-schema-recovery-sr5-v11-live-source-admission.ts';
import { PHASE_6_9_8_RETRIEVER_SCHEMA_RECOVERY_SR5_LIVE_SOURCE_BINDING_SCHEMA } from './phase-6-9-8-retriever-final-response-schema-recovery-sr5-v11-live-source-manifest.ts';
import {
...
} from './phase-6-9-8-retriever-final-response-schema-recovery-sr5-v11-live-journal-contract.ts';
...
const FORMAL_FILE =
  /^phase-6-9-8-retriever-final-response-schema-recovery-sr5-live-v11(?:\.marker|-[0-9a-f-]{36}\.(?:journal\.jsonl|recovery\.claim|report\.json)|-[0-9a-f-]{36}\.report\.json\.tmp\.[0-9a-f-]{36})$/u;
