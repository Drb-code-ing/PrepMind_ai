...
import type { WrongQuestionOrganizerV5CandidateResult } from '../model-candidates/wrong-question-organizer-v5-model-candidate.ts';
import type { WrongQuestionOrganizerV5ShortlistSource } from '../model-candidates/wrong-question-organizer-v5-shortlist.ts';
...
export function buildPhase697V5TutorSemanticAxes(
  entry: Phase697V2TutorRuntimeCase,
  actual: TutorStrategy,
): Extract<NonNullable<Phase697V5RuntimeResult['semanticAxes']>, { agent: 'tutor' }> {
...
export function buildPhase697V5OrganizerSource(
...
export function buildPhase697V5OrganizerSemanticAxes(
  entry: Phase697V2OrganizerRuntimeCase,
  actual: WrongQuestionOrganizerV5CandidateResult,
): Omit<
  Extract<
    NonNullable<Phase697V5RuntimeResult['semanticAxes']>,
...
export function runPhase697V5ZeroCallCase(
