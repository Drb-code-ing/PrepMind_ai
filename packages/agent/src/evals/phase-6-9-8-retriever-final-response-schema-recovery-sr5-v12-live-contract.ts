...
} from './phase-6-9-8-retriever-final-response-schema-recovery-sr5-v12-live-source-manifest.ts';
import {
...
} from './phase-6-9-8-retriever-final-response-schema-recovery-sr5-v12-live-source-schema.ts';
...
export const PHASE_6_9_8_RETRIEVER_SCHEMA_RECOVERY_SR5_LIVE_REPORT_VERSION =
  'phase-6.9.8-retriever-final-response-schema-recovery-sr5-live-report-v2' as const;
export const PHASE_6_9_8_RETRIEVER_SCHEMA_RECOVERY_SR5_LIVE_POLICY_VERSION =
  'phase-6.9.8-retriever-final-response-schema-recovery-sr5-live-policy-v2' as const;
export const PHASE_6_9_8_RETRIEVER_SCHEMA_RECOVERY_SR5_LIVE_AUTHORITY =
  'controlled_live_retriever_final_response_schema_recovery_sr5_v12' as const;
export const PHASE_6_9_8_RETRIEVER_SCHEMA_RECOVERY_SR5_LIVE_EVIDENCE_NAMESPACE =
  'phase-6-9-8-retriever-final-response-schema-recovery-sr5-live-v12' as const;
export const PHASE_6_9_8_RETRIEVER_SCHEMA_RECOVERY_SR5_LIVE_SYNTHETIC_AUTHORITY =
  'synthetic_test_retriever_final_response_schema_recovery_sr5_v12' as const;
export const PHASE_6_9_8_RETRIEVER_SCHEMA_RECOVERY_SR5_LIVE_QUALITY_AUTHORITY =
  'schema_recovery_sr5_v12_branch_semantic_gate' as const;
export const PHASE_6_9_8_RETRIEVER_SCHEMA_RECOVERY_SR5_LIVE_DATA_BOUNDARY_ENV =
  'PHASE_6_9_8_RETRIEVER_FINAL_RESPONSE_SCHEMA_RECOVERY_SR5_V12_DATA_BOUNDARY_ACCEPTED' as const;
export const PHASE_6_9_8_RETRIEVER_SCHEMA_RECOVERY_SR5_LIVE_APPROVAL_ENV =
  'PHASE_6_9_8_RETRIEVER_FINAL_RESPONSE_SCHEMA_RECOVERY_SR5_V12_APPROVED' as const;
export const PHASE_6_9_8_RETRIEVER_SCHEMA_RECOVERY_SR5_LIVE_DATA_BOUNDARY_CONFIRMATION =
  'I_ACCEPT_PHASE_6_9_8_RETRIEVER_FINAL_RESPONSE_SCHEMA_RECOVERY_SR5_V12_DEEPSEEK_AND_QWEN_DATA_BOUNDARY' as const;
export const PHASE_6_9_8_RETRIEVER_SCHEMA_RECOVERY_SR5_LIVE_AUTHORIZATION_CONFIRMATION =
  'I_AUTHORIZE_PHASE_6_9_8_RETRIEVER_FINAL_RESPONSE_SCHEMA_RECOVERY_SR5_V12_CONTROLLED_LIVE_ONCE' as const;
...
export const PHASE_6_9_8_RETRIEVER_SCHEMA_RECOVERY_SR5_LIVE_VALIDATE_ARGUMENT =
  'VALIDATE_PHASE_6_9_8_RETRIEVER_FINAL_RESPONSE_SCHEMA_RECOVERY_SR5_V12_CONTROLLED_LIVE_BUNDLE' as const;
export const PHASE_6_9_8_RETRIEVER_SCHEMA_RECOVERY_SR5_LIVE_RECOVER_ARGUMENT =
  'RECOVER_PHASE_6_9_8_RETRIEVER_FINAL_RESPONSE_SCHEMA_RECOVERY_SR5_V12_CRASH_ONLY_ONCE' as const;
...
const GATE_SCHEMA = z
  .object({
    status: z.enum([
      'schema_recovery_sr5_v12_branch_semantic_gate_passed',
  ...
  .superRefine((value, context) => {
    const passed =
      value.status === 'schema_recovery_sr5_v12_branch_semantic_gate_passed' &&
