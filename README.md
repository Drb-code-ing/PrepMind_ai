...
| Phase 6.9.7   | Tutor/WrongQuestionOrganizer 混合模型、教学策略与组织层写入隔离                                | V1/V2/V3 Live 失败封存；V4 R0--R4 完成，阶段未完成 |
...
V3 R5 已再次复核 V1/V2 四个历史 SHA 与专用 validator；V3 marker/journal/evidence 已按 run `ff2e1a54...` 封存。禁止删除 marker、重跑 V1/V2/V3 或把部分成功拼接成通过。V4 使用新的 runner/prompt/marker/journal/evidence/validator；R5 checkpoint 与新的精确授权完成前不得调用 Provider。
