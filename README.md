...
L3 后的 Full-gate Schema Recovery SR0--SR3 已分别完成 zero-provider 设计、TDD、robustness 与独立 runner/durability checkpoint。SR1 新增 exact-schema raw-content parser capability、有界 native JSON parser、canonical integer `intentIndex` selection projection、strict projected decision 与 bounded no-raw diagnostic；contract SHA 固定为 `e2453fae...11579`。SR2 冻结 Provider-like/held-out/metamorphic/schema-negative fixture（SHA `43248bfa...0d41e`），覆盖全部 24 个 Tutor runtime（含 `tutor-v2-runtime-11`）、18 个 Provider shape、fault/abort 与 pair breaker。SR3 又以独立 `schema-recovery-v1` lineage 落成 report/runner/source/CLI、fsynced schema-stage hash-chain journal、hard-link artifact、strict validator 与 crash-only recovery；source manifest SHA 为 `1a811394...adfbb`。SR3 focused `23/23`、兼容 `105/105`、Agent `1167/1167`、AI `325/325` 通过，旧 L3 bytes/tag/validator 不变，正式 SR5 files/tag 为 0。SR3 authority 仅 `zero_provider_full_gate_schema_recovery_runner_durability / qualityAuthority=none`；当前下一原子任务仅 SR4 zero-provider reviewed Mock/static。
