...
1. Phase 6.9.5 的 V1--V9 保持只读历史；V9 唯一 Live 已质量门失败并封存，V9 committed success 不成立，产品 gate 默认关闭，阶段仍未完成。
2. 下一步是基于 V9 脱敏 aggregate 进行最小质量根因修复并建立新 lineage；不得重跑或改写 V1--V9，也不得提前进入 Docker、浏览器、产品验收、main replay 或 push。
