...
## SR5 v7 recovery gate

- [ ] Active CLI binds `main` and the immutable v7 tag.
- [ ] Focused and merged-main zero-provider suites pass.
- [ ] v7 annotated tag and local/remote parity are verified.
- [ ] Fresh V7 DeepSeek/Qwen boundary acceptance and exact authorization are recorded.
