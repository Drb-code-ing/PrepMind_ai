...
字段只形成 fixed bucket/shape diagnostic 后丢弃。SR1 TDD、SR2 robustness、SR3 独立
runner/lineage/durability 与 SR4 reviewed Mock/static 已 zero-provider 完成。SR4 得到 `48/48`
...
授权。详见 Schema Recovery
`docs/superpowers/specs/phase-6-9-7-tutor-organizer-full-gate-schema-recovery-design.md` 与 SR4
