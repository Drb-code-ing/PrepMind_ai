...
5. Phase 6.4：补充错题集数据模型与 contract。
6. Phase 6.5：错题本 UI 改为学科卡片 + 专题 deck 下钻。
7. Phase 6.6：接入 WrongQuestionOrganizerAgent，实现错题保存后的归类建议。
8. Phase 6.7：PlannerAgent 联动复习压力、错题专题和 RAG 资料片段，生成学习建议。
9. Phase 6.8：MemoryAgent 沉淀用户偏好和长期学习线索。
