...
- Create: `docs/acceptance/phase-6-9-4-1-router-verifier-baseline.md`
- Rename: 已有日期前缀 Router/Verifier 评测计划 ->
  `docs/superpowers/plans/phase-6-9-4-1-router-verifier-eval.md`
- Rename: 已有日期前缀 Router/Verifier 评测设计 ->
  `docs/superpowers/specs/phase-6-9-4-1-router-verifier-eval-design.md`
- Modify: `AGENTS.md`
...
- `docs/superpowers/plans` / `docs/superpowers/specs`：按 Phase 7.6 起的文档规范移除日期前缀，并同步计划内引用。
...
```powershell
rg -n "TBD|TODO|待补|待定|�" `
  docs/acceptance/phase-6-9-4-1-router-verifier-baseline.md `
...
git add docs/superpowers/plans/phase-6-9-4-1-router-verifier-eval.md `
  docs/superpowers/specs/phase-6-9-4-1-router-verifier-eval-design.md
