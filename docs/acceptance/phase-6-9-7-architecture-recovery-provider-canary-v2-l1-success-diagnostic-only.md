...
后续状态（2026-07-31）：P1 设计与 G1 zero-provider contract/baseline 已完成，均未调用 Provider；当前下一
任务仅 G2 one-shot runner/durability。该补注不改写本页 L1 run、artifact 或 authority。
