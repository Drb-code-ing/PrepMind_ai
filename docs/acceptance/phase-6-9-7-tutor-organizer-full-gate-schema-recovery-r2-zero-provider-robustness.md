...
该 checkpoint 当时只解锁 SR6；SR6 随后已以 `providerCalls=0` 完成分支产品验收且不提升 SR5 semantic
authority；SR7 main/default-off 验收随后完成且不提升 SR5 authority。Phase 6.9.7 已收口，当前下一阶段仅
Phase 6.9.8。最新验收见
