...
- Phase 6.9.7 Full-gate Schema Recovery SR1：独立 envelope/parser、selection projection、strict projected decision/local merger 与 bounded diagnostic TDD。（下一任务，zero-provider）
