...
- Phase 6.9.7 Full-gate F1：实现 full manifest/baseline/report/scorer/gate、双向 lineage rejection 与安全 baseline writer；复现 P2 三个 canonical SHA，正式 full-gate evidence 保持 0。（下一任务，zero-provider）
