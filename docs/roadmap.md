...
- Phase 6.9.7 Full-gate F2：实现 full one-shot runner/source/marker/hash-chain journal/hard-link artifact/strict validator/crash-only seal；正式 full-gate evidence 必须继续保持 0。（下一任务，zero-provider）
