...
- Phase 6.9.7 Small-sample P2：只允许基于 L2 sealed 终态进行 zero-provider 24-pair/48-case full semantic-gate 设计；不授权执行全量 Live、产品 Docker/API/browser、main 或后续阶段。（下一任务，zero-provider）
