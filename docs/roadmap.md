...
- Phase 6.9.7 Full-gate Schema Recovery SR3：新 report/runner/CLI/approval/marker/journal/artifact/recovery/validator identity、bounded schema stage durability 与新旧 lineage 双向拒绝；正式文件仍为 0。（下一任务，zero-provider）
