...
- Phase 6.9.7 Full-gate Schema Recovery SR2：Provider-like/held-out/metamorphic/no-leak/fault matrix，覆盖 24 个 Tutor runtime 与 `tutor-v2-runtime-11`，不读取 L3 raw。（下一任务，zero-provider）
