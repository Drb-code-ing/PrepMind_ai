...
| Phase 6   | 多 Agent 系统     | LangGraph, Router, Retriever, Tutor, Verifier, Planner, Memory, Orchestrator, Agent Eval, Layered Memory                                                 | Phase 6.9.4.1 已完成，继续补强 |
...
- Phase 6.9.4.2：Router/Verifier Mock candidate contract 与安全降级。（下一任务）
