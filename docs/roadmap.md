...
> 当前日期：2026-06-17。项目按 Phase 0 ~ Phase 10 顺序推进，当前 Phase 5.0 RAG 知识库设计已完成，下一步进入 Phase 5.1 数据模型与 contract。
...
| Phase 5 | RAG 知识库 | pgvector, Embedding, Hybrid Search, Rerank | 进行中，Phase 5.0 已完成 |
...
- Phase 5.1：RAG 数据模型、pgvector 索引预留、knowledge API contract。
