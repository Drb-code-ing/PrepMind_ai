...
> 当前状态：项目按 Phase 0 ~ Phase 10 顺序推进，当前 Phase 6.3 已完成，后续进入 Phase 6.4 `WrongQuestionOrganizerAgent`。
...
| Phase 6 | 多 Agent 系统 | LangGraph, Router, Retriever, Tutor, Verifier, Planner, Memory, WrongQuestionOrganizer | 进行中，Phase 6.3 已完成 |
...
- TutorAgent 与 KnowledgeVerifierAgent 当前都不直接调用真实模型、不写业务数据；最终输出仍由 `/api/chat` 的现有 mock/live 模型链路负责。
...
- Phase 6.0 / 6.1 / 6.2 / 6.3 详细设计与实施计划见 `docs/superpowers/specs/2026-06-20-phase-6-0-agent-runtime-design.md`、`docs/superpowers/specs/2026-06-20-phase-6-1-router-tutor-chat-integration-design.md`、`docs/superpowers/specs/2026-06-20-phase-6-2-tutor-agent-policy-design.md`、`docs/superpowers/specs/2026-06-21-phase-6-3-knowledge-verifier-design.md` 以及对应 `docs/superpowers/plans/` 文件。
...
- Phase 6.4：`WrongQuestionOrganizerAgent`，错题本学科卡片和专题 deck。（下一步）
