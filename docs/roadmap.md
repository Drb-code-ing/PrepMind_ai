...
- Phase 6.9.7 Full-gate S3：reviewed Mock 真实穿过两条 candidate、第一方 adapter、strict validator、本地 merger 与 F2 runner，并完成 full/anchor semantic、P95、预算、fault/static/history parity 与 Reader Testing；不创建 approved tag。（下一任务，zero-provider）
