...
下一会话可以复制：“请从最新 main/branch 继续 Phase 6.9.5 的独立 product-acceptance lineage；V11 已 recovery-only 封存，绝不能重跑或复用。先验证 V11 安全终态与新的离线 contract，再做一次新 lineage branch product。”
