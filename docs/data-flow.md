...
V5 R1 zero-provider dataset authority
  ...
  -> 下一步 R2 zero-provider；无 V5 Live 授权，不启动 Docker/API/browser
```
...
coherent dataset、prompt-safe projection、eval policy 与 deterministic baseline；下一步仅 R2 Tutor
local-signal authority。详见
