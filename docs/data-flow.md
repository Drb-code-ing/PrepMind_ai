...
V4 R0 zero-provider postmortem
  ...
  -> R1--R5 zero-network/static/Mock；没有新精确授权则不进入 V4 Live
...
V4 R4 independent robustness + evidence lineage
  ...
  -> V1/V2/V3 validators/SHA 不变；V4 Live CLI 在 R6 前返回 live_not_available_before_r6
  -> 后续 R5 已完成
