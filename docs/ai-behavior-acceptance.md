...
- 下一任务只能在当前分支合并 main、main 复验并推送后，从新 main 创建唯一一次完整 JSON-mode controlled-Live；只有 28/28 strict success、72/72 zero-call 且所有质量、安全、权限、延迟、token、usage provenance 和成本门槛通过才能完成，否则终局 fallback 并保持候选关闭；
