...
- 下一个 controlled-Live 任务只能在当前分支合并 main、main 复验并推送后，从新 main 创建。必须完整重跑 100 cases，只有 28/28 strict success、72/72 zero-call 且所有质量、安全、权限、延迟、token、usage provenance 和成本门槛通过才能完成；
