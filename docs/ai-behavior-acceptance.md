...
SR4 是 Retriever/FinalResponse 生产形状链路与 schema recovery 边界验收，不是真实 Provider 质量验收。当前分支
`drb/phase-6-9-8-retriever-final-response-schema-recovery-sr4` 固定 `8` 条 zero-call guard、`6` 条 rewrite、`6` 条
