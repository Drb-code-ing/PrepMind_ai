...
- Live preflight 必须早于 UUID、evidence reservation/fs、Provider factory 和 runner，且只有明确 `true` 才能继续。新 Live 报告必须使用 `phase-6.9.4.3-runner-v2` + `deepseek_strict_tool_v1`；历史 runner v1 Live 只读兼容，Mock v1/v2 均禁止携带 Live transport 字段；
