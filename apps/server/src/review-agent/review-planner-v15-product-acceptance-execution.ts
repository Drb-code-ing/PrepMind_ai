...
import {
  ...
  type ReviewPlannerV15ProductAcceptanceManifest,
...
export type ReviewPlannerV15ProductAcceptanceSafeEvent = Readonly<{
...
export function createReviewPlannerV15ProductAcceptanceRunnerLedgerAdapter(input: {
  ...
  ledger: Pick<
    ...
    | 'finalizeSuccess'
  >;
  manifest: ReviewPlannerV15ProductAcceptanceManifest;
  ...
  if (
    ...
    throw new Error('V15_PRODUCT_ACCEPTANCE_EXECUTION_INVALID');
  }
  ...
  return Object.freeze({
    ...
    recordDefaultOff(value) {
      ...
      let record;
      try {
        record = parseReviewPlannerV15ProductAcceptanceDefaultOff({
          ...v8Receipt,
          schemaVersion:
