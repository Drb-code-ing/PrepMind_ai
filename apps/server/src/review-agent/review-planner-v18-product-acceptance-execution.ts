...
import {
  ...
  type ReviewPlannerV18ProductAcceptanceManifest,
...
export type ReviewPlannerV18ProductAcceptanceSafeEvent = Readonly<{
...
export function createReviewPlannerV18ProductAcceptanceRunnerLedgerAdapter(input: {
  ...
  ledger: Pick<
    ...
    | 'finalizeSuccess'
  >;
  manifest: ReviewPlannerV18ProductAcceptanceManifest;
  ...
  if (
    ...
    throw new Error('V18_PRODUCT_ACCEPTANCE_EXECUTION_INVALID');
  }
  ...
  return Object.freeze({
    ...
    recordDefaultOff(value) {
      ...
      let record;
      try {
        record = parseReviewPlannerV18ProductAcceptanceDefaultOff({
          ...v8Receipt,
          schemaVersion:
