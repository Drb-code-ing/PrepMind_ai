...
import {
  ...
  type ReviewPlannerV22ProductAcceptanceManifest,
...
export type ReviewPlannerV22ProductAcceptanceSafeEvent = Readonly<{
...
export function createReviewPlannerV22ProductAcceptanceRunnerLedgerAdapter(input: {
  ...
  ledger: Pick<
    ...
    | 'finalizeSuccess'
  >;
  manifest: ReviewPlannerV22ProductAcceptanceManifest;
  ...
  if (
    ...
    throw new Error('V22_PRODUCT_ACCEPTANCE_EXECUTION_INVALID');
  }
  ...
  return Object.freeze({
    ...
    recordDefaultOff(value) {
      ...
      let record;
      try {
        record = parseReviewPlannerV22ProductAcceptanceDefaultOff({
          ...v8Receipt,
          schemaVersion:
