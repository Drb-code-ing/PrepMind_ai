...
import {
  ...
  type ReviewPlannerV21ProductAcceptanceManifest,
...
export type ReviewPlannerV21ProductAcceptanceSafeEvent = Readonly<{
...
export function createReviewPlannerV21ProductAcceptanceRunnerLedgerAdapter(input: {
  ...
  ledger: Pick<
    ...
    | 'finalizeSuccess'
  >;
  manifest: ReviewPlannerV21ProductAcceptanceManifest;
  ...
  if (
    ...
    throw new Error('V21_PRODUCT_ACCEPTANCE_EXECUTION_INVALID');
  }
  ...
  return Object.freeze({
    ...
    recordDefaultOff(value) {
      ...
      let record;
      try {
        record = parseReviewPlannerV21ProductAcceptanceDefaultOff({
          ...v8Receipt,
          schemaVersion:
