...
export type ReviewPlannerV14ProductAcceptanceSafeEvent = Readonly<{
...
export function createReviewPlannerV14ProductAcceptanceRunnerLedgerAdapter(input: {
  ...
  ledger: Pick<
    ...
    | 'finalizeSuccess'
  >;
  manifest: ReviewPlannerV14ProductAcceptanceManifest;
  ...
  if (
    ...
    throw new Error('V14_PRODUCT_ACCEPTANCE_EXECUTION_INVALID');
  }
