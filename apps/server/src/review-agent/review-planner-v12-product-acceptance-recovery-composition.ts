import { readReviewPlannerV12ProductAcceptanceLedger } from './review-planner-v12-product-acceptance-ledger';
import {
...
export type ReviewPlannerV12ProductAcceptanceRecoveryCompositionPorts =
  Readonly<{
    preflight(input: {
...
export async function runReviewPlannerV12ProductAcceptanceRecoveryComposition(input: {
  environment: Environment;
  repoRoot: string;
