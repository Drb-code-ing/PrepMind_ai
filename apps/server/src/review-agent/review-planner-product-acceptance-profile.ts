...
export type ReviewPlannerV21ProductAcceptanceProfile = Readonly<
  Omit<
    ReviewPlannerV19ProductAcceptanceProfile,
    | 'lineage'
    | 'errorPrefix'
  ...
  > & {
    lineage: 'v21';
    errorPrefix: 'V21_PRODUCT_ACCEPTANCE';
    productConfirmation: '--confirm-v21-review-planner-product-acceptance';
    recoveryConfirmation: '--confirm-v21-review-planner-product-acceptance-recovery-only';
    schemas: Readonly<{
      failure: 'phase-6.9.5-v21-product-acceptance-failure-v1';
      checkpoint: 'phase-6.9.5-v21-product-acceptance-checkpoint-v1';
      manifest: 'phase-6.9.5-v21-product-acceptance-manifest-v1';
      executionManifest: 'phase-6.9.5-v21-product-acceptance-execution-manifest-v1';
      slotResult: 'phase-6.9.5-v21-product-acceptance-slot-result-v1';
      defaultOff: 'phase-6.9.5-v21-product-acceptance-default-off-v1';
      ownerIsolation: 'phase-6.9.5-v21-product-acceptance-owner-isolation-v1';
      cleanup: 'phase-6.9.5-v21-product-acceptance-cleanup-v1';
      acceptance: 'phase-6.9.5-v21-product-acceptance-aggregate-v1';
      success: 'phase-6.9.5-v21-product-acceptance-success-v1';
      recovery: 'phase-6.9.5-v21-product-acceptance-recovery-v1';
    }>;
  }
>;
...
export const REVIEW_PLANNER_V21_PRODUCT_ACCEPTANCE_PROFILE =
  Object.freeze<ReviewPlannerV21ProductAcceptanceProfile>({
    lineage: 'v21',
    errorPrefix: 'V21_PRODUCT_ACCEPTANCE',
    productConfirmation: '--confirm-v21-review-planner-product-acceptance',
    recoveryConfirmation:
      '--confirm-v21-review-planner-product-acceptance-recovery-only',
    schemas: Object.freeze({
      failure: 'phase-6.9.5-v21-product-acceptance-failure-v1',
      checkpoint: 'phase-6.9.5-v21-product-acceptance-checkpoint-v1',
      manifest: 'phase-6.9.5-v21-product-acceptance-manifest-v1',
    ...
    publicLedgerPath: (environment) =>
      `docs/acceptance/evidence/phase-6-9-5-v21-product-acceptance/${environment}`,
    recoveryPath: (environment) =>
      `.tmp/phase-6-9-5-v21-product-acceptance/${environment}`,
    browserProfilePath: (environment) =>
      `.tmp/phase-6-9-5-v21-product-acceptance/${environment}/profile-v21`,
    publicLedgerSegments: (environment) =>
      Object.freeze([
        'docs',
        'acceptance',
        'evidence',
        'phase-6-9-5-v21-product-acceptance',
        environment,
      ]),
    recoverySegments: (environment) =>
      Object.freeze([
    ...
    executionManifestPath: (environment) =>
      `.tmp/phase-6-9-5-v21-product-acceptance-execution/${environment}`,
    executionManifestSegments: (environment) =>
      Object.freeze([
        '.tmp',
        'phase-6-9-5-v21-product-acceptance-execution',
        environment,
      ]),
  });
