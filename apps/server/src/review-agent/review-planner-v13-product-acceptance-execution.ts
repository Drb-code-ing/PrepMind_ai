...
export type ReviewPlannerV13ProductAcceptanceSafeEvent = Readonly<{
...
export function createReviewPlannerV13ProductAcceptanceRunnerLedgerAdapter(input: {
  ...
  ledger: Pick<
    ...
    | 'finalizeSuccess'
  >;
  manifest: ReviewPlannerV13ProductAcceptanceManifest;
  ...
  if (
    ...
    throw new Error('V13_PRODUCT_ACCEPTANCE_EXECUTION_INVALID');
  }
