...
describe('Review Planner V18 recovery composition', () => {
  it('blocks a missing or damaged V18 terminal before host recovery', async () => {
  ...
  it('recovers a V18-only failure through default-off and cleanup exactly once', async () => {
