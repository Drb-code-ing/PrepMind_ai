...
import {
  ...
  type ReviewPlannerV19ProductAcceptanceManifest,
...
export type ReviewPlannerV19ProductAcceptanceSafeEvent = Readonly<{
...
export function createReviewPlannerV19ProductAcceptanceRunnerLedgerAdapter(input: {
  ...
  ledger: Pick<
    ...
    | 'finalizeSuccess'
  >;
  manifest: ReviewPlannerV19ProductAcceptanceManifest;
  ...
  if (
    ...
    throw new Error('V19_PRODUCT_ACCEPTANCE_EXECUTION_INVALID');
  }
  ...
  return Object.freeze({
    ...
    recordDefaultOff(value) {
      ...
      let record;
      try {
        record = parseReviewPlannerV19ProductAcceptanceDefaultOff({
          ...v8Receipt,
          schemaVersion:
