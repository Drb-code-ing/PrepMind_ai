...
import {
  ...
  type ReviewPlannerV17ProductAcceptanceManifest,
...
export type ReviewPlannerV17ProductAcceptanceSafeEvent = Readonly<{
...
export function createReviewPlannerV17ProductAcceptanceRunnerLedgerAdapter(input: {
  ...
  ledger: Pick<
    ...
    | 'finalizeSuccess'
  >;
  manifest: ReviewPlannerV17ProductAcceptanceManifest;
  ...
  if (
    ...
    throw new Error('V17_PRODUCT_ACCEPTANCE_EXECUTION_INVALID');
  }
  ...
  return Object.freeze({
    ...
    recordDefaultOff(value) {
      ...
      let record;
      try {
        record = parseReviewPlannerV17ProductAcceptanceDefaultOff({
          ...v8Receipt,
          schemaVersion:
