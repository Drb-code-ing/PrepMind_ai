...
import {
  ...
  type ReviewPlannerV20ProductAcceptanceManifest,
...
export type ReviewPlannerV20ProductAcceptanceSafeEvent = Readonly<{
...
export function createReviewPlannerV20ProductAcceptanceRunnerLedgerAdapter(input: {
  ...
  ledger: Pick<
    ...
    | 'finalizeSuccess'
  >;
  manifest: ReviewPlannerV20ProductAcceptanceManifest;
  ...
  if (
    ...
    throw new Error('V20_PRODUCT_ACCEPTANCE_EXECUTION_INVALID');
  }
  ...
  return Object.freeze({
    ...
    recordDefaultOff(value) {
      ...
      let record;
      try {
        record = parseReviewPlannerV20ProductAcceptanceDefaultOff({
          ...v8Receipt,
          schemaVersion:
